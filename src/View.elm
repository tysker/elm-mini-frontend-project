...
view model =
    div []
        ...
        , br [] []
        , br [] []
        , input [ placeholder "Nickname", value model.nickname, onInput Input1] []
        , input [ placeholder "Score", value model.score, onInput Input1] []
        , button [onClick (FetchPost (model.nickname, model.score))] [text "Add A Gamer "]
        ]
